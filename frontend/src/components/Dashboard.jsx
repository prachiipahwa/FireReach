        ...
        <section className="glass-panel" style={{ padding: '1.5rem', height: 'fit-content' }}>
          ...
          {workflowState === 'completed' && (
             <div style={{ textAlign: 'center', padding: '1rem' }}>
                ...
                <p style={{marginTop: '0.5rem', color: 'var(--text-muted)', fontSize: '0.9rem'}}>Check the output panel to view delivery statuses.</p>
                
                <div style={{ marginTop: '1.5rem', background: 'rgba(255,255,255,0.05)', padding: '15px', borderRadius: '8px', textAlign: 'left', fontSize: '0.85rem', color: '#d1d5db' }}>
                   <strong>📬 How to verify delivery?</strong><br/>
                   If your `.env` contains `SENDGRID_API_KEY=mock`, the system intentionally intercepted the email to prevent real-world spam. You will see "Simulated delivery" in the statuses natively. To send *real* emails, swap the key in your `.env` to a valid SendGrid key, and you will be able to verify successful deliveries natively inside your SendGrid Activity Dashboard.
                </div>
